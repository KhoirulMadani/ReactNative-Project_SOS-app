        ...
        <View style={styles.ContainerPersonalData}>
          <View style={styles.personalData}>
            <View style={styles.nameAndImage}>
              <Image
                source={require('../../../SANTRI/assets/images/person.png')}
            ...
            <View style={styles.editPersonalData}>
              <TouchableOpacity
                ...
                <Image
                  source={require('../../../SANTRI/assets/Icons/editPersonal.png')}
      ...
      <View style={styles.ContainerPutih}>
        <View style={styles.ContainerChild}>
          <ContainerChildUserProfile
            source={require('../../../SANTRI/assets/images/cv.png')}
            title="CV"
          ...
          />
          <ContainerChildUserProfile
            source={require('../../../SANTRI/assets/Icons/portofolio.png')}
            title="Portofolio"
            icon={'chevron-forward'}
            style={{
              width: responsiveScreenWidth(11),
          ...
          />
          <ContainerChildUserProfile
            source={require('../../../SANTRI/assets/images/problem.png')}
          ...
          />
          <ContainerChildUserProfile
            source={require('../../../SANTRI/assets/Icons/logout.png')}
